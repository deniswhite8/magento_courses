 ...
 */
class Oggetto_News_Adminhtml_NewsController extends Mage_Adminhtml_Controller_Action
{
    /**
     * Index action
     *
    ...
    {
        $this->loadLayout()
            ->_setActiveMenu('catalog/oggetto_news_news')
    ...
    protected function _isAllowed()
    {
        return Mage::getSingleton('admin/session')->
            isAllowed('catalog/oggetto_news_news');
    }
}